      ...
      <div className="max-w-[1200px] mx-auto px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 text-sm">
          <p className="text-slate-600 mb-4 md:mb-0">
            © {new Date().getFullYear()} CeyPOS. All rights reserved. <br className="md:hidden"/> Built by <a href="https://www.ceynode.com" target="_blank" rel="noopener noreferrer" className="text-slate-700 hover:text-slate-900 transition-colors font-semibold">Ceynode</a>.
          </p>
