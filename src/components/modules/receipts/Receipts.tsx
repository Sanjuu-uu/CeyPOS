...
export const Receipts: React.FC = () => {
  ...
  return (
    <div className="space-y-5">
      <p className="page-subheading">Review and manage customer receipts</p>
                ...
                <div
                  ...
                  className={`p-3 rounded-xl border cursor-pointer transition-colors ${
                    selectedSaleId === sale.id
                      ...
                      : 'border-[#eeeeeb] bg-white hover:bg-gray-50'
                  }`}
            ...
            actions={
              <div className="flex space-x-2">
                <button
                  ...
                  disabled={isPrinting}
                  title="Print receipt"
                  className="rounded-lg border border-[#dfdfda] bg-white px-3 py-2 text-xs font-medium text-[#555550] hover:border-black hover:text-black disabled:opacity-50 disabled:cursor-wait"
                >
                  {isPrinting ? 'Printing...' : 'Print'}
                </button>
                <button
                  className="rounded-lg border border-[#dfdfda] bg-white px-3 py-2 text-xs font-medium text-[#555550] disabled:opacity-50"
              ...
              <div className="mb-6">
                <table className="w-full text-sm">
                  <thead className="bg-[#f3f4f6]">
                    <tr>
                      <th className="px-3 py-3 text-left text-[11px] font-medium uppercase tracking-[0.1em] text-[#666661]">Item</th>
                      <th className="px-3 py-3 text-center text-[11px] font-medium uppercase tracking-[0.1em] text-[#666661]">Qty</th>
                      <th className="px-3 py-3 text-right text-[11px] font-medium uppercase tracking-[0.1em] text-[#666661]">Price</th>
                      <th className="px-3 py-3 text-right text-[11px] font-medium uppercase tracking-[0.1em] text-[#666661]">Total</th>
                    </tr>
                  </thead>
                  <tbody>
