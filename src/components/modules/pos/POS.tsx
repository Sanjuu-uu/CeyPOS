...
export const POS: React.FC = () => {
  ...
  const [, setIsScannerConnected] = useState(false);
          ...
          <div className="p-4 border-b border-gray-100 space-y-4 flex-shrink-0">
            <div className="relative">
              ...
              <input
                ref={searchInputRef}
                type="text"
                className="w-full h-12 pl-10 pr-10 bg-gray-50 border border-gray-200 rounded-lg hover:border-black focus:outline-none focus:ring-2 focus:ring-black focus:border-black text-base transition-all"
