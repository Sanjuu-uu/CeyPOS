...
export const DataValidation: React.FC<DataValidationProps> = ({ data, onValidationComplete }) => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      // Generate sample validation issues
      const sampleIssues: ValidationItem[] = [
        { row: 15, field: 'SKU', value: '', issue: 'SKU is required', type: 'error' },
        { row: 23, field: 'Unit Price', value: '-5.99', issue: 'Price cannot be negative', type: 'error' },
        { row: 45, field: 'Quantity', value: '0', issue: 'Quantity is zero', type: 'warning' },
        { row: 67, field: 'Category', value: 'Misc', issue: 'Category not in standard list', type: 'warning' },
      ];
      setValidationItems(sampleIssues);
    }, 2000);
      ...
      <div className="max-w-4xl mx-auto">
        ...
        {!validationComplete ? (
          ...
          <div className="text-center">
            ...
            >
              Please wait while we check your file for any issues
            </p>
          </div>
        ) : (
          // Validation complete
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <p 
                          ...
                          style={{ color: 'var(--gray--600)' }}
                        >
                          Field: {item.field} • Value: "{item.value || 'Empty'}"
                        </p>
                      </div>
            ...
            <div className="mt-8 flex justify-center gap-4">
              {data.errors > 0 ? (
                ...
                <button
                  ...
                  className="button-primary px-8 py-3 font-medium transition-all duration-200"
                  style={{ 
                    borderRadius: 'var(--radius--12px)',
                    backgroundColor: 'var(--verde-naturale--primary)',
                    color: 'var(--gray--900)',
