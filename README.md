...
- **Business Intelligence**: Advanced analytics with Gemini narratives and hosted AntV visualizations
...
- **Interactive Charts**: Sales trends and revenue analytics generated by Gemini and rendered through the AntV chart service
...
| **AntV MCP Charts** | self-hosted | Remote chart rendering service powering AI visualizations |
...
Create a `.env` file in the repository root (and reuse it for the MCP and server packages) with the following keys:
...
3. Analyze sales trends with AI-generated charts in the analytics chat
...
| **Analytics** | `analytics/Analytics.tsx` | Business intelligence, AI chat, remote visualizations |
